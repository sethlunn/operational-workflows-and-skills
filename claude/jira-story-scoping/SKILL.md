...
description: "Scope work into well-formed Jira stories from an interactive description, a Confluence design document, or a preloaded context file containing a story breakdown. Use when the user asks Claude Code to scope, break down, or draft Jira stories for planned work: gather requirements, decompose into right-sized stories, draft the Key Details fields (Description, Acceptance Criteria, Definition of Done) within strict size limits, flag edges where an engineer-provided code example would improve implementation accuracy, and create the stories in Jira after review. Do not use for implementing an existing story or for incident follow-up planning."
---
